...
import com.example.staj.feature.favourite.FavouritesFragmentDirections
...
class FavouriteMoviesFragment : Fragment() {
    ...
    private fun defineRecyclerView(movies: List<Movie>) {
        ...
        movieAdapter.onMovieClick = { movieId, _ ->
            val action = FavouritesFragmentDirections.favouriteToDetailMovie(movieId)
